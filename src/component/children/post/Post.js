        ...
        <div className={style.post}>
                    ...
                    <div className={style.boxCanvas}>
                        ...
                        <div className={style.infPost}>
                            ...
                            <div className={style.listBtn}>
                                ...
                                <div className={style.itemBtn}><i><FontAwesomeIcon icon={faBookmark}/></i>Save</div>
                                <div className={style.itemBtn}><i><FontAwesomeIcon icon={faLink}/></i>Share</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className={style.contentPost}>
                <div className={style.content}>
                    <font>
                        Today I want to share a mirror wall DIY. Industrial mirrors can make your space look a lot
                        bigger, so they are excellent for small rooms. This is a very easy, cheap, and fun DIY to do, so
                        let’s dive in.
                    </font>
                    ...
                    <font>The LOTS mirrors come with rectangular stickers of double tape. Place two of them on the back
                    ...
                    <font>Using one of the sticks as your base, place the mirrors on the wall. Make sure to leave space
                        for the wood in between the mirrors. In order to do that simply and without making unnecessary
                        measurements, just place the second stick vertically between the mirrors each time you stick a
                    ...
                    <font>
                        ...
                        horizontally, to mark the space between the first and second row. Once you are done with the
                    ...
                    <font>Just continue to make as many rows as you find suitable. I recommend going to the very ceiling
                        as it will create a visual illusion of a higher ceiling. Use your knee to keep mirrors in place
                        when needed.</font>
                    <img alt={""}
                    ...
                    <font>We are done with the mirrors! The next step is to chop the wood sticks as needed. Place the
                        sticks vertically first, and then place the rest horizontally right on top. Mark where you need
                        to cut them.</font>
                    <img alt={""}
                    ...
                    <font>Spray paint all the sticks. You could also leave them in their natural color, but I think it
                    ...
                    <font>Fix the sticks on the wall in between the mirrors using silicone. Start with the long vertical
                        sticks. Make sure to put silicone on the gaps on the wall, not on the sticks themselves - that
                        way it will be much less messy.</font>
                    <br/>
                    <font>Put the silicone inside, put in the stick, press on it, and repeat between all the mirrors.
                        Make
                    ...
                    <font>This is it! Let’s see the before and after. My room looks so much more spacious now, as well
                        as brighter and taller. Have fun installing your own industrial mirror wall and let me know how
                ...
                <div className={style.relatedProjects}>
                    {
                        RELATED.map((data,index)=>(
                            <div className={style.relatedProject} key={index}>
                                <canvas id={'canvas2'} className={style.canvas2} width={"275.200"} height={"304"}/>
